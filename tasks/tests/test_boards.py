...
class TestGetBoard:
    ...
    def test_if_user_is_authenticated_can_retrieve_task_board_detail_returns_200(self,
                                                                                 user, api_client, valid_board_data):
        """
        Test that the user is authenticated, and can retrieve task board detail.
        :param user:
        :param api_client:
    ...
    def test_if_user_is_anonymous_cannot_retrieve_task_board_detail_returns_401(self
                                                                             , user, api_client, valid_board_data):
        """
        Test that the user is anonymous, and cannot retrieve task board detail.
        :param user:
        :param api_client:
        :param valid_board_data:
        """
